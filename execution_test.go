...
func TestRequest_Execute_Filter(t *testing.T) {
	defer gock.Off()
	defer assert.True(t, gock.IsDone())
...
func TestRequest_Execute_Filter_withMultipleValues(t *testing.T) {
	defer gock.Off()
	defer assert.True(t, gock.IsDone())
...
func TestRequest_Execute_Search(t *testing.T) {
	defer gock.Off()
	defer assert.True(t, gock.IsDone())
...
func TestRequest_Execute_Sort(t *testing.T) {
	defer gock.Off()
	defer assert.True(t, gock.IsDone())
